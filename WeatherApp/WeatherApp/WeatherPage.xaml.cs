...
namespace WeatherApp
{
    ...
    public partial class WeatherPage : ContentPage
    {
        ...
        private void Weather()
        {
            ...
            var upperHeader = new Label() { Text = $"{Environment.NewLine}Inside", HorizontalTextAlignment = TextAlignment.Center, VerticalTextAlignment = TextAlignment.Start, FontSize = 40, TextColor = Color.Black };
            ...
            var middleHeader = new Label() { Text = $"{Environment.NewLine} Outside", HorizontalTextAlignment = TextAlignment.Center, VerticalTextAlignment = TextAlignment.Start, FontSize = 40, TextColor = Color.Black };
            ...
            var bottomHeader = new Label() { Text = $"{Environment.NewLine} Pressure", HorizontalTextAlignment = TextAlignment.Center, FontSize = 40, TextColor = Color.Black };
